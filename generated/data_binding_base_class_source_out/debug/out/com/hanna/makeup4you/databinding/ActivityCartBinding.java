...
public final class ActivityCartBinding implements ViewBinding {
  ...
  private ActivityCartBinding(@NonNull RelativeLayout rootView, @NonNull RecyclerView rvItems,
      @NonNull TextView tvNoDataFound) {
  ...
  public static ActivityCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCartBinding((RelativeLayout) rootView, rvItems, tvNoDataFound);
    }
